...
while True:
    ...
    if choice in ('a', 'e'):
        resultaat = CALCULATIONS['addition'](n1, n2)
        teken = '+'
    elif choice in ('b', "f"):
        resultaat = CALCULATIONS['subtraction'](n1, n2)
        teken = '-'
    elif choice in ('c', 'g'):
        resultaat = CALCULATIONS['multiplication'](n1, n2)
        teken = '*'
    elif choice in ('d', 'h'):
        resultaat = CALCULATIONS['division'](n1, n2)
        teken = ':'
